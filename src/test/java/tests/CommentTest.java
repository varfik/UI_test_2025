...
public class CommentTest extends BaseTest{
    ...
    public void AddedCommentIsDisplayed(){
        ...
        try { mainVideoPage.findCommentByText("Хорошее видео!"); }
        catch (Exception e) { commentIsExist = false; }
    ...
    public void DeletedCommentIsNotDisplayed(){
        ...
        try { mainVideoPage.deleteCommentByText("Хорошее видео!"); }
        catch (Exception e) { commentIsDeleted = false; }
