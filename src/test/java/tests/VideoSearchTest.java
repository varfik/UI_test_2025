...
public class VideoSearchTest {
    ...
    /** Тест поиск существующего видео по полному названию:
     ...
     - ввод полного названия существующего видео "Искусственный интеллект и его применение в жизни / Практика 2025 ЛЭТИ 3383"
    ...
    public void searchPartialNameVideo() {
        ...
        Assertions.assertDoesNotThrow(
                resultsPage::clickVideoNameVideoCardModule,
    ...
    public void searchNonExistVideo() {
        ...
        ResultsOfSearchPage resultsPage = SearchService.searchExact(nonExistQuery, SearchType.VIDEO);
        Assertions.assertNotNull(resultsPage, "Страница результатов не загрузилась");
